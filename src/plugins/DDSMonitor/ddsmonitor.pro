DEFINES += DDSMONITOR_LIBRARY

# DDSMonitor files

SOURCES +=         ddsmonitorplugin.cpp

HEADERS +=         ddsmonitorplugin.h         ddsmonitor_global.h         ddsmonitorconstants.h
...
isEmpty(IDE_BUILD_TREE): IDE_BUILD_TREE = "D:/tage/pro/qt-creator-minimal/build-qt-creator-minimal-Desktop_Qt_5_14_2_MSVC2017_64bit-Debug"
