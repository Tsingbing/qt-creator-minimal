DEFINES += USBCANPLUGIN_LIBRARY

# UsbCanPlugin files

SOURCES +=         usbcanpluginplugin.cpp

HEADERS +=         usbcanpluginplugin.h         usbcanplugin_global.h         usbcanpluginconstants.h
