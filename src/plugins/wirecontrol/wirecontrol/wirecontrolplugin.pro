DEFINES += WIRECONTROLPLUGIN_LIBRARY

# WireControlPlugin files

SOURCES +=         wirecontrolpluginplugin.cpp

HEADERS +=         wirecontrolpluginplugin.h         wirecontrolplugin_global.h         wirecontrolpluginconstants.h
...
QTC_PLUGIN_NAME = WireControlPlugin
